...
// ignore: unused_element
  Success<T> success<T>({@nullable T value}) {
    return Success<T>(
      value: value,
    );
  }
...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object>({
    @required TResult success(@nullable T value),
    @required TResult error(String message),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult success(@nullable T value),
...
class _$Success<T> extends Success<T> {
  const _$Success({@nullable this.value}) : super._();
...
abstract class Success<T> extends Result<T> {
  ...
  const factory Success({@nullable T value}) = _$Success<T>;
